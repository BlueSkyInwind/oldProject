//
//  UserLoanApplicationProcessVCModule.m
//  fxdProduct
//
...
#import "UserLoanApplicationProcessVCModule.h"
...
@interface UserLoanApplicationProcessVCModule ()<UITableViewDelegate,UITableViewDataSource>
{
    UIView *_noneView;
    UIView *_toopLine;
...
@implementation UserLoanApplicationProcessVCModule
...
-(UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section{
    ...
    if ([_userStateModel.product_id isEqualToString:SalaryLoan]||[_userStateModel.product_id isEqualToString:WhiteCollarLoan]) {//工薪贷
        ...
        [FXD_Tool setCorner:refuseView.applyBtn borderColor:UI_MAIN_COLOR];
        ...
        refuseView.frame = CGRectZero;
        [FXD_Tool setCorner:refuseView.seeBtn borderColor:UI_MAIN_COLOR];
...
-(void)applyBtn{
    ...
    if([_userStateModel.product_id isEqualToString:SalaryLoan]){
        ...
        UserDataAuthenticationListVCModules *userDataVC = [[UserDataAuthenticationListVCModules alloc] init];
