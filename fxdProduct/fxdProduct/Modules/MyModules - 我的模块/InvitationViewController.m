...
- (void)viewDidLoad {
    ...
    invitationCode.text = [FXD_Tool getContentWithKey:kInvitationCode];
    ...
    NSString *cardStr = [NSString stringWithFormat:@"%@%@?invitation_code=%@",_H5_url,_h5register_url,[FXD_Tool getContentWithKey:kInvitationCode]];
...
-(void)shareContent
{
    ...
    if (imageArr) {
        ...
        NSString *shareUrl = [NSString stringWithFormat:@"%@%@?invitation_code=%@",_H5_url,_h5register_url,[FXD_Tool getContentWithKey:kInvitationCode]];
