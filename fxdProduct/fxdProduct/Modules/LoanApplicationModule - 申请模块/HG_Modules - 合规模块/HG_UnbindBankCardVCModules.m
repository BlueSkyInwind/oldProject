...
@interface HG_UnbindBankCardVCModules ()<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate>
{
...
@implementation HG_UnbindBankCardVCModules
...
-(void)clickBtn{
    ...
    if (_sms_code == nil ||[_sms_code isEqualToString:@""]) {
        ...
        HG_ReplaceBankCardVCModules *controller = [[HG_ReplaceBankCardVCModules alloc]initWithNibName:@"HG_ReplaceBankCardVCModules" bundle:nil];
