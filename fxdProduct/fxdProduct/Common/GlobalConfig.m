...
//NSString * const _main_new_url  =  @"http://test.faxindai.com:8001/apigw/client/";
//NSString * const _H5_url    =   @"http://test.faxindai.com:8001/fxd-h5/page/";
//NSString * const _p2P_url = @"http://test.faxindai.com:8001/fxd-esb/p2p/";
...
//banner 接口
NSString * const    _Banner_url               =    @"banner/getLinkApi";
...
#pragma mark - 信用卡
//信用卡列表
NSString * const    _creaditCardListInfo_url               =    @"jyd/creditCard/recommend/listApi";
//信用卡条件
